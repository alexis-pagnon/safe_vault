...
class _CustomThemeSwitcherState extends State<CustomThemeSwitcher> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Setting up rotation and opacity animations.
        ...
        child: RotationTransition(
          ...
          child: FadeTransition(
            ...
            child: Icon(
              ...
              color: isDark ? Color(0xFFFFFFFF) : Color(0xFF242424),
            ),
          ),
        ),
      ),
